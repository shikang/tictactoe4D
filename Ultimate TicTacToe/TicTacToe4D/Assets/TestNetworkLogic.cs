...
public class TestNetworkLogic : MonoBehaviour 
{
    ...
    public void TagPlayer(int playerID)
    {
        ...
        gameText.GetComponent<GUIText>().text += "TagPlayer: " + playerID;
    ...
    public void TaggedPlayer(int playerID)
    {
        ...
        gameText.GetComponent<GUIText>().text += "TaggedPlayer: " + playerID;
    }
